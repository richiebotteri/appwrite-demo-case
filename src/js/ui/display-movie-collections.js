export function displayMovieCollections(moviesArray) {
   moviesArray.forEach((movie, index) => {
      const { title, genre, year, description, movieCover, $id } = movie;
      ...
      // Card content | title, year, settings bts, cover-img & description
      ...
      <img id="cover" src="${movieCover}" class="card-body movie-cover"/>
